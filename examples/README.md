# zFISHer example dataset - example analysis report

This folder contains an example report for the sample dataset described in the zFISHer manuscript.

The dataset combines DNA FISH (HOXB locus, FITC) with protein immunofluorescence (XPO1, Cy5) in human acute myeloid leukemia Molm13 cell monolayers.
